...
# --- Desktop compatibility shim (add near top of PiicoDev_SSD1306.py) ---
import os
...
# Try to read os.uname(); if missing (e.g., Windows/macOS CPython), fall back.
try:
    _SYSNAME = os.uname().sysname
except Exception:
    _SYSNAME = 'Linux'  # make the driver use its Linux/FrameBuffer path

# If something else slips through, normalize to 'Linux'
if _SYSNAME not in ('microbit', 'Linux'):
    _SYSNAME = 'Linux'
# --- end shim ---
